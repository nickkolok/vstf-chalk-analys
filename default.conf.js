...
module.exports = {
	...
	concurrentDataWritings: 2, // Сколько текстовых файлов может записывать одновременно. Этот можно задирать сильно, они вроде маленькие
	concurrentImageWritings: 2, // То же для изображений. Увеличивать осторожно, а то упадёт от нехватки памяти
}
