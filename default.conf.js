...
module.exports = {
	...
	edgeThresholdCorrection: -15, // Поправка порога яркости
	edgeCenterRadius: 64, // Ширина центровой полосы, по которой считается яркость. Осторожно, влияет на скорость работы! Квадратично!!!
